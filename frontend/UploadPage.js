// ── DemandSense — UploadPage.js ─────────────────────────
// Upload page: user drops a CSV file, clicks forecast,
// and sees the AI-generated demand predictions.
      ...
      <div style={{
        ...
        <div className="card">
          ...
          >
            ...
            {file ? (
              <>
                <p style={{ color: '#2ECC71', fontWeight: '500', marginBottom: '4px' }}>
                  {file.name}
                </p>
